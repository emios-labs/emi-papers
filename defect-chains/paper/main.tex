...
preprint in a public artifact repository, together with a supplementary document
% TODO(url): insert the public repository URL once the principal names the repo.
